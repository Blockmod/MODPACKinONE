...
public class ElectikFurnaceGUIScreen extends AbstractContainerScreen<ElectikFurnaceGUIMenu> {
	...
	public ElectikFurnaceGUIScreen(ElectikFurnaceGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("blockmod_:textures/screens/electik_furnace_gui.png");
